  ...
  return (
    <Card className="rounded-xl border-none">
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-[150px_300px] items-center gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="sender-22700" className="text-sm font-small">
                22700
              </label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="sender-quickpay" />
              <label htmlFor="sender-quickpay" className="text-sm font-small">
                QuickPay
              </label>
            </div>
          </div>
        ...
        <div className="grid grid-cols-[150px_300px] items-center gap-4">
          <CardDescription>Шаблон</CardDescription>
          <Textarea className="w-full rounded-2xl" />
